...
## Display a list of containers and images
...
The command will display all containers contained in your repository; it includes stopped containers and running containers. Why does it show all containers? Because the command includes the flag `-a`, which is shorthand for `--all`. Now, you will see the result as below:
...
Well, you learned some basic commands to control containers. Now, you will learn how to display the list of images in our repository. It's quite easy, you just to run the below command:
...
## How to save data with Docker Volume
